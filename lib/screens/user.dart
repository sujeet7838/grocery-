...
import 'package:grocery/consts/firebase_const.dart';
...
import 'package:grocery/screens/orders/orders_widget.dart';
  ...
  Future<void> getUserData() async {
    ...
    try {
      ...
      final DocumentSnapshot userDoc =
          ...
          print( 'userDoc emaildata///////: ${userDoc.get('email')} ');
      if (userDoc == null) {
         print("helooooooo 45454");
        return;
      } else {
         print("helooooooo n565656o user");
